                            ...
                            <div class="container-fluid">
                                <nav class="nav-select"> 
                                    <ul class="nav-select_list">
                                        <li><a href="egp-bma" title="ชื่อเมนู" class="active">การจัดซื้อจัดจ้างประจำปีของกรุงเทพมหานคร</a></li>
                                        <li><a href="egp-gov" title="ชื่อเมนู">ข้อมูลการจัดซื้อจัดจ้างภาครัฐของหน่วยงาน (e-GP BMA)</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
