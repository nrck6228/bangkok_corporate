        ...
        <div class="container-breadcrumb">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">บริการกรุงเทพมหานคร</li>
                </ol>
            </nav>
        </div>
    </div> 
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card news-main matchHeight">
                                <a href="service-detail" title="ไตเติ้ลข่าวแบบสั้น" class="bg-layer">
                                    <img src="{{ asset('assets/images/news/photo1.jpg')}}" alt="" class="thumbnail">
                                </a>
                                <div class="source">
                                ...
                                <div class="content-layer">
                                    <div class="title">
                                        <a href="service-detail" title="กทม. ตรวจสอบสภาพรถยนต์ หน่วยงานในสังกัด ลดปัญหาฝุ่นลดมลพิษ PM2.5">
                        ...
                        <div class="col-lg-6">
                            <div class="card news-main matchHeight">
                                <a href="service-detail" title="ไตเติ้ลข่าวแบบสั้น" class="bg-layer">
                                    <img src="{{ asset('assets/images/news/photo2.jpg')}}" alt="" class="thumbnail">
                                </a>
                                <div class="source">
                                    <span>PR Bangkok</span>
                                </div>
