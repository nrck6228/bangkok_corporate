                ...
                <div class="container-news">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="card news-main matchHeight">
                                <a href="infographic-detail" title="ไตเติ้ลข่าวแบบสั้น" class="bg-layer">
                                    <img src="{{ asset('assets/images/infographic/photo3.jpg')}}" alt="" class="thumbnail">
                                </a>
                                <div class="source">
                                    <span>PR Bangkok</span>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="card news-main matchHeight">
                                <a href="infographic-detail" title="ไตเติ้ลข่าวแบบสั้น" class="bg-layer">
                                    <img src="{{ asset('assets/images/infographic/photo4.jpg')}}" alt="" class="thumbnail">
                                </a>
                                <div class="source">
                                    <span>PR Bangkok</span>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="card news-main matchHeight">
                                <a href="infographic-detail" title="ไตเติ้ลข่าวแบบสั้น" class="bg-layer">
                                    <img src="{{ asset('assets/images/infographic/photo5.jpg')}}" alt="" class="thumbnail">
                                </a>
                                <div class="source">
                                    <span>PR Bangkok</span>
                                </div>
