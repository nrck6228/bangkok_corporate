<div class="container-wrapper--homepage">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <!-- <div class="tabs-wrapper" data-aos="fade-up" data-aos-delay="300">
                    <ul class="nav nav-tabs" id="myTabNews" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="bkk-news1-tab" data-toggle="tab" href="#bkk-news1" role="tab" aria-controls="bkk-news1" aria-selected="true">ข่าวเด่น</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="bkk-news2-tab" data-toggle="tab" href="#bkk-news2" role="tab" aria-controls="bkk-news2" aria-selected="false">ข่าวผู้บริหาร</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="bkk-news3-tab" data-toggle="tab" href="#bkk-news3" role="tab" aria-controls="bkk-news3" aria-selected="false">ข่าวสอบแข่งขัน / สมัครงาน</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="bkk-news4-tab" data-toggle="tab" href="#bkk-news4" role="tab" aria-controls="bkk-news4" aria-selected="false">ประกาศกรุงเทพฯ</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabNewsContent">
                            ...
                            <div class="container-news">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card news-main matchHeight">
                                            ...
                                            <div class="content-layer">
                                                <div class="title">
                                                    <a href="news-detail" title="กทม. ตรวจสอบสภาพรถยนต์ หน่วยงานในสังกัด ลดปัญหาฝุ่นลดมลพิษ PM2.5">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="card news-list matchHeight">
                                                    <a href="news-detail"  title="ไตเติ้ลข่าวแบบสั้น" class="bg-layer">
                                                        <img src="../../assets/images/news/photo2.jpg" alt="" class="thumbnail">
                                                    </a>
                                                    <div class="source">
                                                        <span>PR Bangkok</span>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a href="news" title="ดูทั้งหมด" class="btn btn-readmore hover-filled-slide-up">
                                            <span>ดูทั้งหมด</span>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="bkk-news3" role="tabpanel" aria-labelledby="bkk-news3-tab">
                            <div class="container-news">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card news-main matchHeight">
                        ...
                        <div class="tab-pane fade" id="bkk-news4" role="tabpanel" aria-labelledby="bkk-news4-tab">
                            <div class="container-news">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card news-main matchHeight">
                ...
                <div class="tabs-wrapper" data-aos="fade-up" data-aos-delay="300">
                    <ul id="myTabNews" class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                    ...
                    <div id="myTabNewsContent" class="tab-content" role="tablist">
                        <div id="pane-C" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="tab-C">
                            ...
                            <div id="collapse3" class="collapse show" aria-labelledby="heading3" data-parent="#myTabNewsContent">
                                <div class="container-news">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card news-main matchHeight">
                        ...
                        <div id="pane-D" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-D">
                            ...
                            <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#myTabNewsContent">
                                <div class="container-news">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card news-main matchHeight">
                        ...
                        <div id="pane-E" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-E">
                            ...
                            <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#myTabNewsContent">
                                <div class="container-news">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card news-main matchHeight">
                        ...
                        <div id="pane-F" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-F">
                            ...
                            <div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#myTabNewsContent">
                                <div class="container-news">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card news-main matchHeight">
