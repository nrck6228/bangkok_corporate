<div class="slider page-home">
    <div class="slider__item">
        <img src="{{ asset('assets/images/main-slide/photo1.jpg')}}" alt="image">
        <a href="www.google.com" title="กรุงเทพฯ ชีวิตดีๆ ที่ลงตัว" class="caption-container">
    ...
    <div class="slider__item">
        <img src="{{ asset('assets/images/main-slide/photo3.jpg')}}" alt="image">
        <a href="www.google.com" title="กรุงเทพฯ ชีวิตดีๆ ที่ลงตัว" class="caption-container">
            <div class="caption-table">
                <div class="caption-cell">
                    กรุงเทพฯ ชีวิตดีๆ ที่ลงตัว
