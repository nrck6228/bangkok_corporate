@section('title', 'บริการกรุงเทพมหานคร')
@section('tagkeyword', '')
                        ...
                        <div class="caption-container">
                            <div class="caption-table">
                                <div class="caption-cell">
                                    <h1 class="title">บริการกรุงเทพมหานคร</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="container-fluid">
                                <nav class="nav-select"> 
                                    <ul class="nav-select_list">
                                        <li><a href="service" title="ชื่อเมนู" class="active">BMA Q</a></li>
                                        <li><a href="service" title="ชื่อเมนู">นัดทิ้งขยะชิ้นใหญ่</a></li>
                                        <li><a href="service" title="ชื่อเมนู">รถบริการเขตเคลื่อนที่</a></li>
                                        <li><a href="service" title="ชื่อเมนู">รพ.ผู้สูงอายุ</a></li>
                                        <li><a href="service" title="ชื่อเมนู">จัดซื้อจัดจ้าง กทม</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
